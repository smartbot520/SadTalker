...
# Define model files and correct URLs
MODEL_URLS = {
    ...
    # Fixed GFPGAN v1.3 model URL
    "checkpoints/gfpgan/GFPGANv1.3.pth": "https://github.com/TencentARC/GFPGAN/releases/download/v1.3.0/GFPGANv1.3.pth"
}
